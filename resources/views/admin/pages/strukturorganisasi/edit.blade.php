...
@section('title', 'Struktur Organisasi | SIMT')

@section('content')
    <div class="row mt-5">
        <div class="col-12">
            <h4 style="color: #47245C">Gambar Struktur Organisasi</h4>
            <img src="{{ asset('dist/assets/img/strukturorganisasi/' . $dataStrukturOrganisasi->image ?? '') }}"
                alt="" class="img-fluid img-thumbnail mb-3" style="max-width: 800px">
            <div class="card">
                <div class="card-body">
                    <div class="tab-content mt-3">
                        <form action="{{ route('strukturorganisasi.update.manage', $dataStrukturOrganisasi->id) }}"
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control" type="text" id="link" name="link"
                                    value="{{ $dataStrukturOrganisasi->link ?? '' }}">
                            </div>
                            <div class="mb-3">
                                <label for="judul" class="form-label fw-bold">Judul</label>
                                <input class="form-control" type="text" id="judul" name="judul"
                                    value="{{ $dataStrukturOrganisasi->judul ?? '' }}">
                            </div>
                            <div class="mb-3">
