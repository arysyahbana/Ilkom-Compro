                                ...
                                <div class="col-6">
                                    ...
                                    <select class="form-select" aria-label="Default select example" id="pangkat"
                                        ...
                                        @foreach ($pangkats as $pangkat)
                                            <option value="{{ $pangkat->id ?? '0' }}">{{ $pangkat->pangkat ?? '' }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col-6">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" aria-label="Default select example" id="jabatan"
                                    ...
                                    @foreach ($jabatans as $jabatan)
                                        <option value="{{ $jabatan->id ?? '0' }}">{{ $jabatan->jabatan ?? '' }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="mb-3">
                                ...
                                <select class="form-select" aria-label="Default select example" id="konsentrasi"
                                    ...
                                    @foreach ($konsentrasis as $konsentrasi)
                                        <option value="{{ $konsentrasi->id ?? '0' }}">{{ $konsentrasi->konsentrasi ?? '' }}
                                        </option>
                                    @endforeach
                                </select>
                            </div>
