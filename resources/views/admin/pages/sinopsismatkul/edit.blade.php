    ...
    <div class="row mt-5">
        <div class="col-12">
            ...
            <a href="{{ asset('dist/assets/pdf/sinopsismatkul/' . $dataSinopsisMatkul->pdf ?? '') }}"
                ...
                target="_blank">{{ $dataSinopsisMatkul->judul ?? '' }}.pdf</a>
            <div class="card">
                <div class="card-body">
                    <div class="tab-content mt-3">
                        <form action="{{ route('sinopsismatkul.update.manage', $dataSinopsisMatkul->id) }}" method="POST"
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control" type="text" id="judul" name="judul"
                                    value="{{ $dataSinopsisMatkul->judul ?? '' }}">
                            </div>
                            <div class="mb-3">
