    ...
    <div class="row mt-5">
        <div class="col-12">
            <div class="d-flex justify-content-between mb-3">
                <h3 style="color: #47245C">Daftar Sinopsis Mata Kuliah</h3>
                <a href="{{ route('sinopsismatkul.create') }}" class="btn btn-sm pt-2 px-3 fw-bold"
                            ...
                            <table id="basic-datatable" class="table dt-responsive nowrap w-100">
                                <thead>
                                    <tr style="background-color: #B92383; color: white; border-radius: 0.5rem">
                                        <th>No</th>
                                        <th>Judul Sinopsis Mata Kuliah</th>
                                        <th>Action</th>
                                    </tr>
                                </thead>
                                    ...
                                    @foreach ($data as $item)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{ route('sinopsismatkul.edit', $item->id) }}" class="btn">
                                                    <img src="{{ asset('dist/images/editIcon.svg') }}" alt="">
                                                </a>
                                                <a href="#" class="btn" data-bs-toggle="modal"
                                                    data-bs-target="#hapussinopsismatkul{{ $item->id }}">
                                                    <img src="{{ asset('dist/images/trashIcon.svg') }}" alt="">
                                                </a>
                                            </td>
                                        </tr>
                                        <!-- Modal Hapus Postingan Berita -->
                                        <div class="modal fade" id="hapussinopsismatkul{{ $item->id }}"
                                            data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
                                            aria-labelledby="hapussinopsismatkulLabel" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-scrollable">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h1 class="modal-title fs-5" id="hapussinopsismatkulLabel">
                                                            Hapus
                                                            Data</h1>
                                                    ...
                                                    <div class="modal-footer">
                                                        <form action="{{ route('sinopsismatkul.destroy', $item->id) }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('DELETE')
                                                            <button type="submit"
