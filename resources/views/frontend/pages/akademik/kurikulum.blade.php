...
@section('content')
    ...
    <div class="page-title dark-background" data-aos="fade"
        ...
        <div class="container position-relative">
            <h2 style="font-weight: bold">Kurikulum Departemen Ilmu Komunikasi</h2>
        </div>
    </div>
    <!-- End Page Title -->
                    ...
                    <table class="table" id="akademik">
                        <thead>
                            <tr>
                                ...
                                <th scope="col" style="background-color: #47245c; color: white">Nama Kurikulum</th>
                        ...
                        <tbody>
                            @foreach ($data as $item)
                                <tr>
                                    ...
                                    <td>{{ $item->judul ?? '' }}</td>
                                    <td><a href="{{ route('akademik.kurikulumdetail', $item->id) }}">Buka disini</a></td>
                                </tr>
                            @endforeach
                        </tbody>
                    </table>
