...
@section('content')
    ...
    <div class="page-title dark-background" data-aos="fade"
        ...
        <div class="container position-relative">
            <h2 style="font-weight: bold">Akreditasi Departemen Ilmu Komunikasi</h2>
        </div>
    </div>
    <!-- End Page Title -->
                    ...
                    <table class="table">
                        <thead>
                            <tr>
                                ...
                                <th scope="col" style="background-color: #47245c; color: white">Nama Akreditasi</th>
                        ...
                        <tbody>
                            @foreach ($data as $item)
                                <tr>
                                    ...
                                    <td>{{ $item->judul ?? '' }}</td>
                                    <td><a href="{{ route('akademik.akreditasidetail', $item->id) }}">Buka disini</a></td>
                                </tr>
                            @endforeach
                        </tbody>
                    </table>
